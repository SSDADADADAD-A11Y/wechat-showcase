...
export const SMILE_HEADS = [
  ...
  ['看破笑', '/game/heads/head-09-kanpo.png'],
  ['敷衍笑', '/game/heads/head-10-qianxing.png'],
  ['尴尬笑', '/game/heads/head-11-ganga.png'],
  ['苦笑', '/game/heads/head-12-kuxiao.png'],
  ['冷笑', '/game/heads/head-13-lengxiao.png'],
  ['忍住笑', '/game/heads/head-14-renzhu.png'],
  ['偷笑', '/game/heads/head-15-touxiao.png'],
  ['释然笑', '/game/heads/head-16-shiran.png'],
  ['慈祥笑 II', '/game/heads/head-17-cixiang-soft.png'],
  ['欣慰笑 II', '/game/heads/head-18-xinwei-soft.png'],
  ['会心笑 II', '/game/heads/head-19-huixin-soft.png'],
  ['鼓励笑 II', '/game/heads/head-20-guli-soft.png'],
  ['治愈笑 II', '/game/heads/head-21-zhiyu-soft.png'],
  ['释怀笑 II', '/game/heads/head-22-shihuai-soft.png'],
  ['安心笑 II', '/game/heads/head-23-anxin-soft.png'],
  ['开怀笑 II', '/game/heads/head-24-kaihuai-soft.png'],
];
